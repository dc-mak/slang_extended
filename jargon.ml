...
let do_oper = function 
  ...
  | (DIV,  STACK_INT m,   STACK_INT n)  -> (try STACK_INT (m / n) with Division_by_zero -> Errors.complain "divisision by zero")
  | (MOD,  STACK_INT m,   STACK_INT n)  -> (try STACK_INT  (m mod n) with Division_by_zero -> Errors.complain "divisision by zero")
