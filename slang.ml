...
let option_spec = [
     ...
     ("-analysis",  Arg.Set static_dbg, "show execution trace of static analysis (type inference)") 
    ] 
...
let _ = Front_end.verbose := !verbose_front
let _ = if !verbose 
        then (
